...
function slaProfielOp() {
    ...
    console.log('Naam:', naam, 'Email:', email, 'Leeftijd:', leeftijd, 'Kleur:', kleur);
...
function laadProfiel() {
    ...
    const naam = document.getElementById('profiel-naam');
    const email = document.getElementById('profiel-email');
    const leeftijd = document.getElementById('profiel-leeftijd');
    const kleur = document.getElementById('profiel-kleur');
...
function wisProfiel() {
    if (confirm('Weet je zeker dat je je profiel wilt wissen?')) {
        ...
        localStorage.removeItem(profile-naam);
        localStorage.removeItem(profile-email);
        localStorage.removeItem(profile-leeftijd);
        localStorage.removeItem(profile-kleur);
        localStorage.removeItem(profile-opgeslagen);
